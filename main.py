...
with xlsxwriter.Workbook("dataOutput.xlsx") as workbook:
    housing_cost_plan_df.write_excel(workbook=workbook,worksheet='Housing Cost')
    thrifthy_plan_df.write_excel(workbook=workbook,worksheet='Food Plans')
    self_sufficiency_standard_df.write_excel(workbook=workbook,worksheet='Self Sufficiency Standard')
